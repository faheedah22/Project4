...
namespace TermProject.Models
{
    public class OfferDB
    {
        ...
        public void GetCustomerOfferInfo(CustomerOfferInfo offerInfo)
        {
        ...
        //to get Agent view
        public List<AgentOffers> AgentOffers(int agentID)
        {
           
            sqlCommand.CommandType = CommandType.StoredProcedure;
            sqlCommand.CommandText = "p4AgentOfferList";
            ...
            foreach (DataRow row in ds.Tables[0].Rows)
            {
                ...
                offer.Home.PropType = row["PropertyType"].ToString();
