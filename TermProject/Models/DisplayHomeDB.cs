    ...
    public class DisplayHomeDB
    {
        ...
        public AgentInfo GetAgentInfo(DBConnect db, int agentID)
        {
            ...
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                info.CompanyName = row["ai.Company_Name"].ToString();
                info.CompanyPhoneNum = row["ai.Company_PhoneNum"].ToString();
                info.CompanyEmail = row["ai.Company_Email"].ToString();
                info.CompanyAddress = row["ai.Company_Address"].ToString();
                info.CompanyCity = row["ai.Company_City"].ToString();
                info.CompanyState = row["ai.Company_State"].ToString();
                info.CompanyZip = row["ai.Company_Zip"].ToString();
        ...
        public HomeInfo DisplayAllHomeInfo(int homeID)
        {
            ...
            foreach (DataRow row in ds.Tables[0].Rows)
            {
                ...
                //  home.Images = AllHomeImages(db, home.HomeID);
