...
using static HomeAPI.Controllers.WordBankHomeChoices;
...
namespace HomeAPI.Controllers
{
    public class HomeDB
    {
        ...
        public void EditHome(HomeInfo home)
        {
            ...
            sqlCommand.Parameters.AddWithValue("@HomeID", home.HomeID);
            sqlCommand.Parameters.AddWithValue("@ListingAddress", home.Address);
            sqlCommand.Parameters.AddWithValue("@ListingCity", home.City);
            sqlCommand.Parameters.AddWithValue("@ListingState", home.State);
            sqlCommand.Parameters.AddWithValue("@ListingZip", home.Zipcode);
            sqlCommand.Parameters.AddWithValue("@PropertyType", home.PropType);
            sqlCommand.Parameters.AddWithValue("@HomePrice", home.HomePrice);
            sqlCommand.Parameters.AddWithValue("@HomeGarage", home.Garage);
            sqlCommand.Parameters.AddWithValue("@HomeInfo", home.Description);
            sqlCommand.Parameters.AddWithValue("@YearBuilt", home.Year);
            sqlCommand.Parameters.AddWithValue("@HomeStatus", home.Status);
            sqlCommand.Parameters.AddWithValue("@WaterType", home.Facilities.WaterType);
            sqlCommand.Parameters.AddWithValue("@SewerType", home.Facilities.SewerType);
            sqlCommand.Parameters.AddWithValue("@Cooling", home.Facilities.Cooling);
            sqlCommand.Parameters.AddWithValue("@Heating", home.Facilities.Heating);

            // Execute the stored procedure using the database connection
        ...
        public bool AddImage(HomeImages img)
        {
            DBConnect db = new DBConnect();
            SqlCommand command = new SqlCommand();
            command.CommandType = CommandType.StoredProcedure;
